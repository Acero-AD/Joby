...
export default function ApplicationsTable({
  ...
  return (
    <div className="flex-1 flex flex-col gap-3 overflow-hidden">
        ...
        {positions.length === 0 ? (
          ...
          positions.map((pos) => (
            <PositionCard
              key={pos.id}
              position={pos}
              onClick={() => router.visit(`/positions/${pos.id}`)}
      ...
      <div className="hidden sm:flex flex-1 bg-white rounded-[14px] shadow-[0_2px_12px_#A855F712] flex-col overflow-hidden">
        {/* Table Header */}
              ...
              >
                ...
                <div className="flex-1 min-w-0 flex items-center gap-2 pr-3">
                  ...
                  <a
                    ...
                    className="flex items-center gap-1 bg-[#F3F0FF] rounded-md py-1 px-2 shrink-0"
                  >
                ...
                {/* CV Used — desktop only */}
                <div className="hidden lg:flex w-[160px] items-center gap-1.5">
                  {pos.cvFilename ? (
                    <>
                      <Icon name="file-text" size={14} className="shrink-0" stroke="#A855F7" />
