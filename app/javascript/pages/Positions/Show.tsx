    ...
    <div className="flex w-[1440px] h-[900px] mx-auto rounded-[20px] bg-gradient-to-br from-bg-start via-bg-mid1 via-70% to-bg-end">
      ...
      <div className="flex flex-col flex-1 gap-6 p-7 px-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <h1 className="text-text-primary text-[26px] font-bold">{position.title || 'Untitled'}</h1>
            ...
            <div className="flex items-center gap-2.5">
              ...
              >
                ...
                <span className="text-[#EF4444] text-sm font-medium">Delete</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[14px] shadow-[0_2px_12px_#A855F712] p-6 flex flex-col gap-5">
          <span className="text-text-primary text-[17px] font-semibold">Application Details</span>
          ...
          <div className="flex gap-8">
            ...
            <div className="flex-1 flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1">
                <span className="text-text-muted text-xs font-medium">Application URL</span>
                {position.url ? (
                  <a
                    href={position.url}
                    target="_blank"
                  ...
                  <span className="text-text-light text-sm">No URL</span>
                )}
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                <span className="text-text-muted text-xs font-medium">CV File</span>
                {position.cvFilename ? (
                  ...
                  <span className="text-text-light text-sm">No CV attached</span>
                )}
              </div>
            </div>
            ...
            <div className="flex-1 flex flex-col gap-5">
              {/* Created */}
              <div className="flex flex-col gap-1">
                <span className="text-text-muted text-xs font-medium">Created</span>
              ...
              {/* Last Updated */}
              <div className="flex flex-col gap-1">
                <span className="text-text-muted text-xs font-medium">Last Updated</span>
                <div className="flex items-center gap-1.5">
                  <svg className="w-3.5 h-3.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="#6B7280" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
